...
const VideoTitle = ({ moviePoster, movieDetails }) => {
  ...
  return (
    <div className="pt-10 lg:pt-20 lg:pl-24 pl-6 absolute text-white  lg:w-[99dvw] w-[100dvw] min-h-[30rem] aspect-video bg-gradient-to-r from-black to-50%">
      <img
      ...
      />
      <p className="lg:w-3/8 w-6/12 mt-4 lg:text-lg md:text-lg text-xs font-semibold selection:text-cyan-500">
        {movieDetails}
      </p>
